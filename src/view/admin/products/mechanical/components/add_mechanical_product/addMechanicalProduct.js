...
const AddMechanicalPage = () => {
  ...
  const SubmitProduct = (e) => {
    ...
    fromdata.append("Cateogry", "Mechanical");

    dispatch(AddNewProduct(fromdata));
    navigate("/mechanical_add_product");
  };
...
export default AddMechanicalPage;
